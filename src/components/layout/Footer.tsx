...
return (
<motion.footer initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}variants={motionVariants.fadeIn}className="bg-dark text-text-on-dark py-12">
