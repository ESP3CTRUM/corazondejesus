...
Tradición, sabor y familia en el corazón del Cibao
    ...
    <section className="py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-heading text-4xl font-semibold text-[var(--text-primary)] mb-6">
          ...
          <h3 className="font-heading text-3xl font-semibold text-[var(--text-primary)] mb-4 mt-12">
    ...
    <section className="py-16 bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h2
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="font-heading text-4xl font-semibold text-[var(--text-primary)] text-center mb-12"
        >
          Nuestro ambiente
        </motion.h2>
